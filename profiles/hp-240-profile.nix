...

{
 ...
 imports = [ 
   ../configurations/hardware-configuration/hp-240/hardware-configuration.nix  ### Hardware configuration file (Include the results of the hardware scan.)
    ../configurations/configs/bootloader/systemd-boot.nix                      ### Systemd boot 
   #../configurations/configs/bootloader/grub2/grub2-efi.nix                   ### Grub 2 Bootloader

...
in
{
  ### Branch name in boot entry label (bootspec) — e.g. "…26.05.20260731.5b4f72e.add-nspawn-utilities"
  system.nixos.label = lib.mkIf (branch != null) (config.system.nixos.version + ".${branch}");

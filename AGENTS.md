...
- Suites in `test/`: `bash test/<name>.sh` (install-logic, repo-info, auto-update-sh, auto-update-checkout, auto-update-env-runtime, auto-update-reboot, nspawnctl, shell-paths).
